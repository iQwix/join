...
?>
<p class="text">Country <select class="select1" name="country" >
                <option name="country" value="0" selected>Choose</option>
                ...
                <option name="country" valuname="country" e="CH">Switzerland</option>
